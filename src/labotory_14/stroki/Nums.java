...
public class Nums {
    ...
    String createStr() {
        ...
        while (true) {
            ...
            if (strMethods.isOnlySpaces(str)) {
                System.out.println("\u001B[31mСтрока состоит только из пробелов\u001B[0m");
            } else return str;
        }
    }
    ...
    public void num2() {
        ...
        if (strMethods.isOnlyOneWord(str)) {
            System.out.println("\u001B[31mСтрока состоит из 1 слова/символа, нужно минимум 2 слова\u001B[0m");
        } else {
